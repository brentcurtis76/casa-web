...
export const UniversalSlide: React.FC<UniversalSlideProps> = ({
  ...
  // Full-bleed image branch: when the slide carries text baked into the image
  // (e.g., generated by an image model), render the image only and skip every
  // text overlay. The legacy render path below is intentionally left untouched.
  if (slide.metadata?.textBakedIn === true && slide.content.imageUrl) {
    const bakedBackgroundColor =
      styleOverrides?.slideBackground?.color ?? CASA_BRAND.colors.primary.white;
    return (
      <div
        ...
        style={{
          ...
          backgroundColor: bakedBackgroundColor,
