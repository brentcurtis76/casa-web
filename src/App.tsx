...
const router = createBrowserRouter([
  ...
  { path: "/admin/liturgia/temporadas", element: <ProtectedRoute requires={{ resource: 'liturgy_seasons', action: 'read' }}><LiturgicalSeasonAdminPage /></ProtectedRoute> },
  { path: "/admin/liturgia/oraciones", element: <ProtectedRoute requires={{ resource: 'oraciones', action: 'read' }}><OracionesAntifonalesPage /></ProtectedRoute> },
  { path: "/admin/liturgia/canciones", element: <ProtectedRoute requires={{ resource: 'canciones', action: 'read' }}><CancionesPage /></ProtectedRoute> },
  { path: "/admin/liturgia/elementos-fijos", element: <ProtectedRoute requires={{ resource: 'elementos_fijos', action: 'read' }}><ElementosFijosPage /></ProtectedRoute> },
