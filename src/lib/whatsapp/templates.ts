...
export const WA_TEMPLATES = {
  ...
  opt_in_bienvenida: {
    ...
    category: 'UTILITY',
    body:
      'Hola {{1}}, gracias por activar las notificaciones por WhatsApp del equipo de música de CASA. Aquí enviaremos asignaciones, recordatorios y cambios de servicio.',
    variables: ['nombre'],
  },
