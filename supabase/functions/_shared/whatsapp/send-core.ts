// Shared send pipeline used by wa-send (publication / on-demand) and
// wa-reminders (cron). Keeps phone normalization, gating, Graph API call,
// and notification log writes in a single place.
