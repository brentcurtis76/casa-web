...
serve(async (req) => {
  ...
  // Validate caller JWT (the SUPABASE_SERVICE_ROLE_KEY counts as a service-role
  // bearer; user JWTs are also accepted — auth gating beyond that is left to
  // the calling component, which already enforces role checks).
