...
Deno.test("PD-envelope a valid story still returns the pre-PD success shape", async () => {
  ...
  // Declared PREL divergence: the envelope echoes the handler's own `MODEL`,
  // which PREL integration moved to main@d79d329's bare alias. Value-only
  // update — the envelope SHAPE this case guards is unchanged.
